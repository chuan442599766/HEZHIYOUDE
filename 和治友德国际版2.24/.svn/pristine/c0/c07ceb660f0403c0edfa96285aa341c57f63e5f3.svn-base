...
- (void)setUpSubview{
    ...
    //设置layout 属性
    layout.itemSize = (CGSize){self.bounds.size.width,(mainScreenHeight - 124)};
...
- (void)layoutSubviews{
    ...
    self.contentView.frame = CGRectMake(0, CGRectGetMaxY(self.tabbar.frame), rect.size.width,(mainScreenHeight - 124));
