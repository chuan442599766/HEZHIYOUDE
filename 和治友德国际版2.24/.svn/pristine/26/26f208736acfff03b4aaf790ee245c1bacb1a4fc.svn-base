...
@interface LZexchangeViewController ()

@end

@implementation LZexchangeViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.
    self.topview.layer.cornerRadius=4.0;
    self.footview.layer.cornerRadius=4.0;
    self.title=@"兑换";
    ...
    self.moneytext1.keyboardType=UIKeyboardTypeNumberPad;
}
-(void)back:(id)sender
{
