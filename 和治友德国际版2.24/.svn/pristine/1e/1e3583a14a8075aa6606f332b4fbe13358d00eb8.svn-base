//
//  LZwithdrawcashViewController.m
//  和治友德国际版
//
...
@interface LZwithdrawcashViewController ()

@end

@implementation LZwithdrawcashViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.
    self.tixianbtn.layer.cornerRadius=4.0;
    self.title=@"提现";
